...
export const demoGames: Game[] = [
  ...
  { id: "demo-neon-tideline", slug: "neon-tideline", title: "Neon Tideline", titleEn: "Neon Tideline", creator: "Morrow Studio", creatorHandle: "morrow", description: "跟著潮汐脈動，在變形的色彩海岸收集散落的訊號。", category: "冒險", tags: ["節奏", "氛圍", "短篇"], plays: 6214, badge: "編輯精選", art: "tide", license: "CC BY-NC 4.0", allowDownload: false, version: "0.9.2", playUrl: "/demo/neon-tideline/index.html" },
