...
export async function SiteHeader() {
  ...
  return (
    <header className="site-header inner-header">
      ...
      <nav className="main-nav" aria-label={copy(locale, "主要導覽", "Main navigation")}><a href="/games">{copy(locale, "探索遊戲", "Explore")}</a><a href="/upload">{copy(locale, "上傳作品", "Upload")}</a><a href="/convert">{copy(locale, "轉換檢查", "Converter")}</a><a href="/guidelines">{copy(locale, "社群規範", "Guidelines")}</a></nav>
